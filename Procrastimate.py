...
def main():
    ...
    while True:
        ...
        mydb = mysql.connector.connect(host='localhost', user='root', passwd='$rmap@2025', database='procrastimate')
    ...
    def sch_rem():
        ...
        for reminder in sc_output:
            tree.insert('', 'end', values=(reminder[4], reminder[0], reminder[1], reminder[2], reminder[3]))
            #tree.insert('', 'end', values=reminder)
    ...
    path=Image.open("/Users/noorehera/Documents/WhatsApp Image 2023-06-24 at 5.33.33 PM.jpeg")
